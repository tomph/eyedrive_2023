...
using Dreamteck.Splines;
    ...
    [CustomEditor(typeof(NodeGate), true)]
    public class NodeEditor : Editor
    {
        private SplineComputer addComp = null;
        private int addPoint = 0;
        private NodeGate lastnode = null;
    ...
    void RenderConnections()
        {
            ...
            if (connections.Length > 0)
            {
                ...
                //_ngcs[i].intention = (Intention)EditorGUILayout.EnumPopup("", _ngcs[i].intention);
            ...
            SplineComputer lastComp = addComp;
            bool dragged = Dreamteck.DreamteckEditorGUI.DropArea<SplineComputer>(rect, out addComps);
